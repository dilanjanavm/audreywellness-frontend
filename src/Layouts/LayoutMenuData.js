...
import { hasPermission, hasAnyPermission } from "../helpers/permissionHelper";
...
const Navdata = () => {
    ...
    const menuItems = [
        ...
        },
        {
            label: "Users",
            isHeader: true,
            permission: ['USER_VIEW', 'CUSTOMER_VIEW', 'ROLE_VIEW', 'PERMISSION_VIEW'] // Show header if user has any of these
        },
        ...
        },
        {
            label: "Other",
            isHeader: true,
            permission: ['CATEGORY_VIEW', 'ITEM_VIEW', 'COSTING_VIEW', 'SUPPLIER_VIEW', 'COMPLAINT_VIEW', 'RECIPE_VIEW']
        },
        {
        ...
        return items.filter(item => {
            ...
            if (item.permission) {
                if (Array.isArray(item.permission)) {
                    hasItemPermission = hasAnyPermission(item.permission);
                } else {
                    hasItemPermission = hasPermission(item.permission);
                }
            }
