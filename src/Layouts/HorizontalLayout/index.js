...
const HorizontalLayout = (props) => {
    ...
    menuItems.push({ id: 'more', label: 'More', icon: <FeatherIcon icon="briefcase" className="icon-dual" />, link: "/#", stateVariables: isMoreMenu, subItems: splitMenuItems, click: function (e) { e.preventDefault(); setIsMoreMenu(!isMoreMenu); }, });
