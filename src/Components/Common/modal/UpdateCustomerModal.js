...
import {User, Mail, Phone, MapPin, Compass, Users, Hash, Map, Calendar} from 'react-feather';
...
const UpdateCustomerModal = ({
    ...
    const handleSubmit = (values) => {
        // Format the DOB date before submitting to match create component
                        ...
                        <Row gutter={16}>
                            <Col span={12}>
                                <Form.Item
                                    label="City/Area"
                                    name="cityArea"
                                    rules={[{required: true, message: 'Please enter city/area'}]}
                                >
                                    <Input
                        ...
                        <Row gutter={16}>
                            <Col span={12}>
                                <Form.Item
                                    label="Sales Group"
                                    name="salesGroup"
                                    rules={[{required: true, message: 'Please enter sales group'}]}
                                >
                                    <Input
