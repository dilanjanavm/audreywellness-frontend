// src/components/supplier/UpdateSupplierModal.js
import React, { useState, useEffect } from 'react';
import { Modal, Form, Input, Select, Button, Row, Col, Switch, Divider, Descriptions, Tag } from 'antd';
        ...
        if (visible) {
            ...
            if (supplier) {
                form.setFieldsValue({
                    ...
                    itemIds: supplier.items ? supplier.items.map(item => item.id) : []
                });
            }
        }
