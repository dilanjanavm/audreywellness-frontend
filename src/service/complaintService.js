...
export const sendComplaintSMS = (id, smsData) => {
    const apiObject = {};
    apiObject.method = 'POST';
    apiObject.authentication = true;
    apiObject.endpoint = `complaints/${id}/send-sms`;
    apiObject.body = smsData;
    return ApiService.callApi(apiObject);
};

export const getPublicComplaintStatus = (complaintNumber) => {
    const apiObject = {};
    apiObject.method = 'GET';
    apiObject.authentication = false;
    apiObject.endpoint = `complaints/public/status/${complaintNumber}`;
    return ApiService.callApi(apiObject);
};